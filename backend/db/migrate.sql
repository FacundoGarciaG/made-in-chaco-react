...
-- 23. Tabla de palabras regionales chaqueñas
...
-- 24. Agregar columna significado a palabras_chaco si ya existe
ALTER TABLE palabras_chaco ADD COLUMN IF NOT EXISTS significado TEXT;
