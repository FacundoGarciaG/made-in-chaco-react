...
SELECT * FROM (VALUES
  ('Mensual', '30 días de visibilidad en el mapa para tu comercio, hospedaje, producto o evento.', 5000, 30, 1),
  ('Trimestral', '90 días de visibilidad con un descuento del 15%.', 12000, 90, 1),
  ('Anual', 'Un año entero de visibilidad con el mejor descuento. Ahorrá un 30%.', 38000, 365, 1),
  ('Anual +3', 'Tres entidades publicadas por un año al mejor precio.', 80000, 365, 3)
) AS p(nombre, descripcion, precio, duracion_dias, entidades_incluidas)
